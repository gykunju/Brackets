-- ============================================
-- BRACKETS LEARNING PLATFORM - COMPLETE DATABASE SETUP
-- Copy and paste this entire file into Supabase SQL Editor
-- ============================================

-- DROP EXISTING TABLES (Run this if you get "relation already exists" errors)
...
DROP TABLE IF EXISTS public.village_circles CASCADE;
...
-- SAMPLE DATA (OPTIONAL - DELETE THIS SECTION IF YOU DON'T WANT SAMPLE DATA)
